...
const BangladeshMap = ({ serviceCenters }) => {
  ...
  return (
    <div className="w-full h-[800px] rounded-lg overflow-hidden shadow-lg relative">
      {/* Search box */}
      <form
        onSubmit={handleSearch}
        className="absolute top-4 left-1/2 transform -translate-x-1/2 z-[1000] w-full max-w-md px-4 flex bg-white"
      >
        <input
          type="text"
      ...
      >
        ...
        {serviceCenters.map((center, index) => (
          <Marker
            ...
            icon={customIcon}
          >
            <Popup autoPan={center.district === activeDistrict}>
              <div>
